    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-emerald-600 selection:text-white">
      ...
      <section id="hero" className="relative pt-6 sm:pt-10 pb-16 sm:pb-20 px-6 overflow-hidden bg-gradient-to-b from-emerald-500/5 via-teal-500/5 to-slate-50/60 border-b border-slate-200/60">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          {/* 🖼️ HERO PHONE IMAGE - PERFECT BALANCED ELEGANT SCALE WITH ROUNDED CORNERS */}
          <div className="lg:col-span-5 flex justify-center items-center relative">
            <div className="rounded-[28px] overflow-hidden shadow-xl border-[2px] border-slate-200/90 hover:scale-105 transition-transform duration-500 max-w-[235px] sm:max-w-[255px] lg:max-w-[270px] w-full bg-white">
              <img
                src="/hero-banner.png"
      ...
      <section id="stores" className="py-8 px-6 bg-slate-50/70 border-b border-slate-200/80">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 max-w-4xl mx-auto">
            {/* Real Registered Stores - Perfect 1:1 Square Cards */}
            {stores.map(s => {
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 px-6 text-xs">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 mb-8 pb-8 border-b border-slate-800">
          ...
          <div className="space-y-2 text-center md:text-right">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-end gap-4 text-xs font-bold text-slate-300">
